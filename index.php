...
<nav class="navbar navbar-expand-lg nav_style p-3">
  <a class="navbar-brand pl-5" href="#">COVID-19 Awareness System</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto pr-5 text-capitalize">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#aboutid">symptoms</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#sympid">About</a>
      </li>
      <li class="nav-item">
	  ...
	  <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="#contactid">Register Yourself</a>
      </li>
...
<section class="corona_update">
	<div class="mb-3">
		<h3 class="text-uppercase text-center">covid-19 updates in maharastra </h3>
	</div>

	<div class="d-flex justify-content-around align-items-center count_style">
		<div>
			<h1 class="count">6181247</h1>
			<p>Confirmed cases</p>
		</div>

		<div>
			<h1 class="count">106764</h1>
			<p>Active COVID-19 cases*</p>
		</div>


		<div>
			<h1 class="count">5944801</h1>
			<p>Recovered/discharged cases</p>
		</div>

		<div>
			<h1 class="count">126390</h1>
			<p>Death cases</p>
		</div>
	</div>
...
<footer class="mt-5">
	<div class="footer_style text-white text-center container-fluid">
		<p>Copyright By Prashant londhe </p>
	</div>
</footer>
